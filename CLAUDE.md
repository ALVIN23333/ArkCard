...
- `unity-mcp-workflow` v1.0.2 - Efficient workflow for using Unity MCP to edit, import, compile, inspect, and test Unity projects.
...
- Project root: `D:\unityXiangmu\ArkCard`
- Product name: `明日方舟卡牌`
<!-- /Funplay Unity MCP managed project skills -->
